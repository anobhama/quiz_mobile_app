...
class VersionedParcelParcel extends VersionedParcel {
    ...
    VersionedParcelParcel(Parcel p) {
        Parcel parcel = p;
        this(parcel, p.dataPosition(), p.dataSize(), BuildConfig.FLAVOR, new ArrayMap(), new ArrayMap(), new ArrayMap());
    }
    ...
    public VersionedParcel createSubParcel() {
        ...
        sb.append("  ");
        VersionedParcelParcel versionedParcelParcel = new VersionedParcelParcel(parcel, dataPosition, i2, sb.toString(), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
