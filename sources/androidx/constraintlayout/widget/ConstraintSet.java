...
public class ConstraintSet {
    ...
    private static class Constraint {
        ...
        public void fillFromConstraints(ConstraintHelper helper, int viewId, LayoutParams param) {
        ...
        /* access modifiers changed from: private */
        public void fillFromConstraints(int viewId, LayoutParams param) {
    ...
    public void center(int centerID, int firstID, int firstSide, int firstMargin, int secondId, int secondSide, int secondMargin, float bias) {
        ...
        if (firstMargin < 0) {
            ...
            ((Constraint) this.mConstraints.get(Integer.valueOf(centerID))).horizontalBias = f;
        } else if (i == 6 || i == 7) {
            int i3 = centerID;
            ...
            ((Constraint) this.mConstraints.get(Integer.valueOf(centerID))).verticalBias = f;
        }
    }
        ...
        switch (startSide) {
            case 1:
                if (endSide == 1) {
                    ...
                    sb.append("Left to ");
                    sb.append(sideToString(endSide));
                    sb.append(str2);
            ...
            case 2:
                if (endSide == 1) {
                    ...
                    sb2.append(str);
                    sb2.append(sideToString(endSide));
                    sb2.append(str2);
            ...
            case 3:
                if (endSide == 3) {
                    ...
                    sb3.append(str);
                    sb3.append(sideToString(endSide));
                    sb3.append(str2);
            ...
            case 4:
                if (endSide == 4) {
                    ...
                    sb4.append(str);
                    sb4.append(sideToString(endSide));
                    sb4.append(str2);
            ...
            case 5:
                ...
                sb5.append(str);
                sb5.append(sideToString(endSide));
                sb5.append(str2);
            ...
            case 6:
                if (endSide == 6) {
                    ...
                    sb6.append(str);
                    sb6.append(sideToString(endSide));
                    sb6.append(str2);
            ...
            case 7:
                if (endSide == 7) {
                    ...
                    sb7.append(str);
                    sb7.append(sideToString(endSide));
                    sb7.append(str2);
            ...
            default:
                ...
                sb8.append(sideToString(startSide));
                sb8.append(" to ");
                sb8.append(sideToString(endSide));
                sb8.append(" unknown");
                        ...
                        default:
                            ...
                            switch (i2) {
                                ...
                                case 75:
                                    ...
                                    sb.append(str);
                                    sb.append(mapToConstant.get(attr));
                                ...
                                default:
                                    ...
                                    sb2.append(str);
                                    sb2.append(mapToConstant.get(attr));
