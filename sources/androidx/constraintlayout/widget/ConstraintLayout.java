...
public class ConstraintLayout extends ViewGroup {
    ...
    private void setChildrenConstraints() {
        ...
        if (helperCount2 > 0) {
            for (int i6 = 0; i6 < helperCount2; i6++) {
                ((ConstraintHelper) this.mConstraintHelpers.get(i6)).updatePreLayout(this);
            }
        }
        ...
        while (i8 < count2) {
            ...
            if (widget2 == null) {
                ...
                if (layoutParams2.isGuideline) {
                    ...
                    int resolvedLeftToLeft8 = resolvedLeftToLeft7;
                    if (VERSION.SDK_INT < 17) {
                        ...
                        if (resolvedLeftToLeft9 == -1 && resolvedLeftToRight3 == -1) {
                            ...
                            if (resolvedRightToLeft4 == -1 || resolvedRightToRight3 != -1) {
                                ...
                                if (layoutParams2.endToStart != -1) {
                                    ...
                                    int i9 = resolvedRightToRight3;
                                    resolvedRightToRight = layoutParams2.endToStart;
                                    resolvedRightToLeft = i9;
                                } else if (layoutParams2.endToEnd != -1) {
                                    resolvedLeftToLeft2 = resolvedLeftToLeft5;
                                    resolvedLeftToLeft = resolveGoneLeftMargin3;
                                    resolveGoneLeftMargin = resolvedLeftToRight;
                                    resolvedRightToRight = resolvedRightToLeft4;
                                    resolvedRightToLeft = layoutParams2.endToEnd;
                                }
                            }
                            resolvedLeftToLeft2 = resolvedLeftToLeft5;
                            resolvedLeftToLeft = resolveGoneLeftMargin3;
                            resolveGoneLeftMargin = resolvedLeftToRight;
                            int i10 = resolvedRightToRight3;
                            resolvedRightToRight = resolvedRightToLeft4;
                            resolvedRightToLeft = i10;
                        } else {
                            resolvedLeftToLeft6 = resolvedLeftToLeft9;
                        }
                        resolvedLeftToRight = resolvedLeftToRight3;
                        ...
                        resolvedLeftToLeft = resolveGoneLeftMargin3;
                        resolveGoneLeftMargin = resolvedLeftToRight;
                        int i102 = resolvedRightToRight3;
                        resolvedRightToRight = resolvedRightToLeft4;
                        resolvedRightToLeft = i102;
                    } else {
                        resolvedLeftToLeft2 = resolvedLeftToLeft8;
                        ...
                        resolvedRightToLeft = i11;
                    }
                    if (layoutParams2.circleConstraint != -1) {
                        ConstraintWidget target = getTargetWidget(layoutParams2.circleConstraint);
                        if (target != null) {
                            count = count2;
                            widget2.connectCircularConstraint(target, layoutParams2.circleAngle, layoutParams2.circleRadius);
                        } else {
                            count = count2;
                        }
                        ...
                        helperCount = helperCount2;
                        View view2 = child3;
                        int resolvedLeftToLeft10 = resolvedRightToLeft;
                        int i13 = resolvedRightToRight;
                        int helperCount3 = resolveGoneLeftMargin;
                        layoutParams = layoutParams2;
                    } else {
                        count = count2;
                        if (resolvedLeftToLeft2 != -1) {
                            ConstraintWidget target2 = getTargetWidget(resolvedLeftToLeft2);
                            if (target2 != null) {
                                Type type = Type.LEFT;
                                Type type2 = Type.LEFT;
                                int i14 = resolvedLeftToLeft2;
                                resolvedLeftToLeft3 = resolvedRightToLeft;
                                ConstraintWidget constraintWidget = target2;
                                ConstraintWidget constraintWidget2 = target2;
                                resolvedRightToLeft2 = resolvedRightToRight;
                                Type type3 = type2;
                                helperCount = helperCount2;
                                int helperCount4 = resolveGoneLeftMargin;
                                int resolvedLeftToRight4 = layoutParams2.leftMargin;
                                View view3 = child3;
                                layoutParams = layoutParams2;
                                widget2.immediateConnect(type, constraintWidget, type3, resolvedLeftToRight4, resolvedLeftToLeft);
                            } else {
                                ConstraintWidget constraintWidget3 = target2;
                                helperCount = helperCount2;
                                View view4 = child3;
                                resolvedLeftToLeft3 = resolvedRightToLeft;
                                resolvedRightToLeft2 = resolvedRightToRight;
                                int helperCount5 = resolveGoneLeftMargin;
                                layoutParams = layoutParams2;
                            }
                        } else {
                            helperCount = helperCount2;
                            ...
                            layoutParams = layoutParams2;
                            if (helperCount6 != -1) {
                                ConstraintWidget target3 = getTargetWidget(helperCount6);
                                if (target3 != null) {
                                    widget2.immediateConnect(Type.LEFT, target3, Type.RIGHT, layoutParams.leftMargin, resolvedLeftToLeft);
                                }
                            }
                        }
                        if (resolvedRightToLeft2 != -1) {
                            ConstraintWidget target4 = getTargetWidget(resolvedRightToLeft2);
                            if (target4 != null) {
                                widget2.immediateConnect(Type.RIGHT, target4, Type.LEFT, layoutParams.rightMargin, resolveGoneRightMargin);
                            }
                        } else if (resolvedLeftToLeft3 != -1) {
                            ConstraintWidget target5 = getTargetWidget(resolvedLeftToLeft3);
                            if (target5 != null) {
                                widget2.immediateConnect(Type.RIGHT, target5, Type.RIGHT, layoutParams.rightMargin, resolveGoneRightMargin);
                            }
                        }
                        if (layoutParams.topToTop != -1) {
                            ConstraintWidget target6 = getTargetWidget(layoutParams.topToTop);
                            if (target6 != null) {
                                widget2.immediateConnect(Type.TOP, target6, Type.TOP, layoutParams.topMargin, layoutParams.goneTopMargin);
                            }
                        } else if (layoutParams.topToBottom != -1) {
                            ConstraintWidget target7 = getTargetWidget(layoutParams.topToBottom);
                            if (target7 != null) {
                                widget2.immediateConnect(Type.TOP, target7, Type.BOTTOM, layoutParams.topMargin, layoutParams.goneTopMargin);
                            }
                        }
                        if (layoutParams.bottomToTop != -1) {
                            ConstraintWidget target8 = getTargetWidget(layoutParams.bottomToTop);
                            if (target8 != null) {
                                widget2.immediateConnect(Type.BOTTOM, target8, Type.TOP, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
                            }
                        } else if (layoutParams.bottomToBottom != -1) {
                            ConstraintWidget target9 = getTargetWidget(layoutParams.bottomToBottom);
                            if (target9 != null) {
                                widget2.immediateConnect(Type.BOTTOM, target9, Type.BOTTOM, layoutParams.bottomMargin, layoutParams.goneBottomMargin);
                            }
                        }
                        if (layoutParams.baselineToBaseline != -1) {
                            View view6 = (View) this.mChildrenByIds.get(layoutParams.baselineToBaseline);
                            ...
                            if (!(target10 == null || view6 == null || !(view6.getLayoutParams() instanceof LayoutParams))) {
                                LayoutParams targetParams = (LayoutParams) view6.getLayoutParams();
                                ...
                                baseline.connect(target10.getAnchor(Type.BASELINE), 0, -1, Strength.STRONG, 0, USE_CONSTRAINTS_HELPER);
                    ...
                    if (layoutParams.horizontalDimensionFixed) {
                        ...
                        widget2.getAnchor(Type.LEFT).mMargin = layoutParams.leftMargin;
                        widget2.getAnchor(Type.RIGHT).mMargin = layoutParams.rightMargin;
                    } else {
                    ...
                    if (!layoutParams.verticalDimensionFixed) {
                        ...
                        if (layoutParams.height == -1) {
                            ...
                            widget2.getAnchor(Type.TOP).mMargin = layoutParams.topMargin;
                            widget2.getAnchor(Type.BOTTOM).mMargin = layoutParams.bottomMargin;
                            z = false;
                        } else {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (!params.isGuideline && !params.isHelper) {
                    ...
                    if (params.horizontalDimensionFixed || params.verticalDimensionFixed || (!params.horizontalDimensionFixed && params.matchConstraintDefaultWidth == 1) || params.width == -1 || (!params.verticalDimensionFixed && (params.matchConstraintDefaultHeight == 1 || params.height == -1))) {
                        ...
                        if (height == 0) {
                            int childHeightMeasureSpec2 = getChildMeasureSpec(i2, heightPadding, -2);
            ...
            if (child.getVisibility() == 8) {
                ...
                if (params.isGuideline) {
                    ...
                    if (width == 0) {
                        ...
                        child.measure(childWidthMeasureSpec2, getChildMeasureSpec(i4, heightPadding3, height));
                        Metrics metrics = constraintLayout.mMetrics;
                        if (metrics != null) {
                            heightPadding = heightPadding3;
                            metrics.measures++;
        ...
        while (i6 < widgetsCount2) {
            ...
            if (child2.getVisibility() == i) {
                ...
                if (params2.isGuideline) {
                    ...
                    widthPadding = widthPadding2;
                    widgetsCount = widgetsCount2;
                    LayoutParams layoutParams = params2;
                    ...
                    if (width3 == 0 || height3 == 0) {
                        ...
                        if (width3 != 0 || height3 != 0 || !bothHorizontal || !bothVertical) {
                            ...
                            if (height3 != 0) {
                                ...
                                if (height3 == -1) {
                                    childHeightMeasureSpec = getChildMeasureSpec(i7, heightPadding4, -1);
                                } else {
                                    if (height3 == -2) {
                                        didWrapMeasureHeight2 = USE_CONSTRAINTS_HELPER;
                                    }
                                    childHeightMeasureSpec = getChildMeasureSpec(i7, heightPadding4, height3);
                                }
                            } else if (!resolveHeight2 || !widget2.isSpreadHeight() || !bothVertical || !top.isResolved() || !bottom.isResolved()) {
                                int childHeightMeasureSpec2 = getChildMeasureSpec(parentHeightSpec, heightPadding4, -2);
                                didWrapMeasureHeight2 = USE_CONSTRAINTS_HELPER;
                                resolveHeight = false;
                                childHeightMeasureSpec = childHeightMeasureSpec2;
                            } else {
                                ...
                                childHeightMeasureSpec = getChildMeasureSpec(parentHeightSpec, heightPadding4, height3);
                            }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (sizeDependentWidgetsCount > 0) {
            int i4 = widthMode;
            boolean containerWrapWidth2 = this.mLayoutWidget.getHorizontalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
            int i5 = widthSize;
            boolean containerWrapHeight = this.mLayoutWidget.getVerticalDimensionBehaviour() == DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
            int i6 = heightMode;
            ...
            while (i9 < sizeDependentWidgetsCount) {
                ...
                ConstraintWidget widget = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i9);
                        ...
                        if (child.getVisibility() != 8 && (!optimiseDimensions || !widget.getResolutionWidth().isResolved() || !widget.getResolutionHeight().isResolved())) {
                            ...
                            if (measuredWidth != widget.getWidth()) {
                                ...
                                if (!containerWrapWidth2 || widget.getRight() <= minWidth2) {
                                    ...
                                    minWidth2 = Math.max(minWidth2, widget.getRight() + widget.getAnchor(Type.RIGHT).getMargin());
                                }
            ...
            if (needSolverPass2) {
                ...
                startingWidth = startingWidth5;
                int i14 = startingHeight3;
            }
            int i15 = 0;
            while (true) {
                int sizeDependentWidgetsCount4 = sizeDependentWidgetsCount3;
                if (i15 >= sizeDependentWidgetsCount4) {
                    break;
                }
                ConstraintWidget widget2 = (ConstraintWidget) this.mVariableDimensionsWidgets.get(i15);
                ...
                if (child2 == null) {
                    ...
                    if (child2.getMeasuredWidth() == widget2.getWidth() && child2.getMeasuredHeight() == widget2.getHeight()) {
                        ...
                        int widthSpec2 = MeasureSpec.makeMeasureSpec(widget2.getWidth(), 1073741824);
                        containerWrapWidth = containerWrapWidth2;
                        int heightSpec2 = MeasureSpec.makeMeasureSpec(widget2.getHeight(), 1073741824);
            ...
            int i22 = paddingLeft;
            int i23 = paddingTop;
            int i24 = startingWidth4;
            int paddingLeft2 = sizeDependentWidgetsCount;
        ...
        if (VERSION.SDK_INT >= 11) {
            int resolvedHeightSize = resolveSizeAndState(androidLayoutHeight, heightMeasureSpec, childState << 16) & ViewCompat.MEASURED_SIZE_MASK;
            int resolvedWidthSize = Math.min(this.mMaxWidth, resolveSizeAndState(androidLayoutWidth, widthMeasureSpec, childState) & ViewCompat.MEASURED_SIZE_MASK);
        ...
        int i25 = widthMeasureSpec;
        int i26 = heightMeasureSpec;
