            ...
            if (!done) {
                ...
                if (firstNode.target == null) {
                    ...
                    if (firstNode.target.state != 1) {
                        ...
                        boolean isChainSpreadInside3 = isChainSpreadInside;
                        ...
                        if (numMatchConstraints3 <= 0 || numMatchConstraints3 != numVisibleWidgets2) {
                            ...
                            boolean isChainSpread5 = isChainSpread;
                            LinearSystem linearSystem6 = system;
                            if (distance < 0.0f) {
                                isChainPacked = true;
                                isChainSpread5 = false;
                                isChainSpread3 = false;
                            } else {
                                isChainSpread3 = isChainSpreadInside3;
                            ...
                            if (isChainPacked) {
                                ...
                                while (widget6 != null) {
                                    ...
                                    if (next3 != null || widget6 == last) {
                                        ...
                                        widget6.mListAnchors[offset].getResolutionNode().addResolvedValue(linearSystem6);
                                        widget6.mListAnchors[offset + 1].getResolutionNode().addResolvedValue(linearSystem6);
                                ...
                                if (isChainSpread5 || isChainSpread3) {
                                    if (isChainSpread5) {
                                    ...
                                    if (!isChainSpread5 || firstVisibleWidget == null) {
                                        widget = widget7;
                                        distance2 = distance6;
                                    } else {
                                        widget = widget7;
                                    ...
                                    while (widget != null) {
                                        if (LinearSystem.sMetrics != null) {
                                            ...
                                            boolean isChainSpreadInside4 = isChainSpread3;
                                            first = first2;
                                            metrics4.nonresolvedWidgets--;
                                            Metrics metrics5 = LinearSystem.sMetrics;
                                            isChainSpreadInside2 = isChainSpreadInside4;
                        ...
                        ConstraintWidget widget8 = first2;
                            ...
                            if (next5 != null || widget8 == last) {
                                ...
                                if (totalWeights2 > 0.0f) {
                                    if (widget8.mWeight[i] == -1.0f) {
                                        ...
                                        dimension3 = (widget8.mWeight[i] * distance7) / totalWeights2;
                                    }
                                }
                                ...
                                widget8.mListAnchors[offset].getResolutionNode().addResolvedValue(linearSystem7);
                                widget8.mListAnchors[offset + 1].getResolutionNode().addResolvedValue(linearSystem7);
