...
public final class ColorUtils {
    ...
    public static Color compositeColors(Color foreground, Color background) {
        ...
        sb.append(foreground.getModel());
        sb.append(" vs. ");
        sb.append(background.getModel());
        sb.append(")");
    ...
    public static double calculateContrast(int foreground, int background) {
        ...
        sb.append(Integer.toHexString(background));
        throw new IllegalArgumentException(sb.toString());
    }
    ...
    public static void RGBToXYZ(int r, int g, int b, double[] outXyz) {
        ...
        if (dArr.length == 3) {
            ...
            dArr[2] = ((0.0193d * sr2) + (0.1192d * sg2) + (0.9505d * sb2)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
        int i = r;
        int i2 = g;
