...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public static final class Message {
            ...
            public Message(CharSequence text, long timestamp, CharSequence sender) {
                this(text, timestamp, new androidx.core.app.Person.Builder().setName(sender).build());
            }
            ...
            static Message getMessageFromBundle(Bundle bundle) {
                ...
                String str3 = KEY_DATA_MIME_TYPE;
                    ...
                    if (bundle.containsKey(str8)) {
                        if (bundle.containsKey(str7)) {
                            ...
                            if (bundle.containsKey(str6)) {
                                person = Person.fromBundle(bundle.getBundle(str6));
                            } else if (bundle.containsKey(str5) && VERSION.SDK_INT >= 28) {
                                person = Person.fromAndroidPerson((Person) bundle.getParcelable(str5));
                            } else if (bundle.containsKey(str4)) {
                                person = new androidx.core.app.Person.Builder().setName(bundle.getCharSequence(str4)).build();
                            }
                            Message message = new Message(bundle.getCharSequence(str8), bundle.getLong(str7), person);
        ...
        public MessagingStyle(CharSequence userDisplayName) {
            this.mUser = new androidx.core.app.Person.Builder().setName(userDisplayName).build();
        }
        ...
        public MessagingStyle addMessage(CharSequence text, long timestamp, CharSequence sender) {
            this.mMessages.add(new Message(text, timestamp, new androidx.core.app.Person.Builder().setName(sender).build()));
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (this.mConversationTitle != null && this.mIsGroupConversation.booleanValue()) {
                ...
                builder.getBuilder().setContentTitle(BuildConfig.FLAVOR);
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            CharSequence text = BuildConfig.FLAVOR;
            CharSequence replyName = person == null ? text : message.getPerson().getName();
        ...
        public void restoreFromCompatExtras(Bundle extras) {
            ...
            if (extras.containsKey(str)) {
                ...
                this.mUser = new androidx.core.app.Person.Builder().setName(extras.getString(NotificationCompat.EXTRA_SELF_DISPLAY_NAME)).build();
            }
            ...
            String str2 = NotificationCompat.EXTRA_IS_GROUP_CONVERSATION;
            if (extras.containsKey(str2)) {
                this.mIsGroupConversation = Boolean.valueOf(extras.getBoolean(str2));
            }
        }
    }
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (VERSION.SDK_INT >= 16 && VERSION.SDK_INT < 21) {
                ...
                if (minPriority) {
                    contentView.setInt(R.id.notification_background, str, R.drawable.notification_bg_low);
                    contentView.setInt(R.id.icon, str, R.drawable.notification_template_icon_low_bg);
                } else {
                    contentView.setInt(R.id.notification_background, str, R.drawable.notification_bg);
                    contentView.setInt(R.id.icon, str, R.drawable.notification_template_icon_bg);
                }
            }
        ...
        public Builder extend(Builder builder) {
            ...
            if (!this.mActions.isEmpty()) {
                ...
                if (i >= 16) {
                    ...
                    wearableBundle.putParcelableArrayList(str, parcelables);
                } else {
                    wearableBundle.putParcelableArrayList(str, null);
                }
            }
            int i2 = this.mFlags;
            if (i2 != 1) {
    ...
    static Action getActionCompatFromAction(android.app.Notification.Action action) {
        ...
        boolean allowGeneratedReplies = VERSION.SDK_INT >= 24 ? action.getExtras().getBoolean(str) || action.getAllowGeneratedReplies() : action.getExtras().getBoolean(str);
