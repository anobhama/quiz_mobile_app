    ...
    public static void onActivityCreate(Activity activity) {
        ...
        if (!sp.getBoolean(str, false)) {
            ...
            if (launchIntent != null) {
                if ("android.intent.action.MAIN".equals(launchIntent.getAction()) && (launchIntent.hasCategory("android.intent.category.LAUNCHER") || launchIntent.hasCategory(IntentCompat.CATEGORY_LEANBACK_LAUNCHER))) {
