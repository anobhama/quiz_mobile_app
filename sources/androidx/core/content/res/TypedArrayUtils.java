...
public class TypedArrayUtils {
    ...
    public static ComplexColorCompat getNamedComplexColor(TypedArray a, XmlPullParser parser, Theme theme, String attrName, int resId, int defaultValue) {
        if (hasAttribute(parser, attrName)) {
    ...
    public static ColorStateList getNamedColorStateList(TypedArray a, XmlPullParser parser, Theme theme, String attrName, int resId) {
        if (!hasAttribute(parser, attrName)) {
            return null;
        }
        TypedValue value = new TypedValue();
