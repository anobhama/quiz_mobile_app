...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
        ...
        public AnimatedVectorDrawableCompatState(Context context, AnimatedVectorDrawableCompatState copy, Callback owner, Resources res) {
            if (copy != null) {
                ...
                if (vectorDrawableCompat != null) {
                    ConstantState cs = vectorDrawableCompat.getConstantState();
                    if (res != null) {
    ...
    private static void registerPlatformCallback(AnimatedVectorDrawable avd, AnimationCallback callback) {
