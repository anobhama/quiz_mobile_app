...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (vPath.isClipPath()) {
                    this.mRenderPath.setFillType(vPath2.mFillRule == 0 ? FillType.WINDING : FillType.EVEN_ODD);
    ...
    private void updateStateFromTypedArray(TypedArray a, XmlPullParser parser, Theme theme) throws XmlPullParserException {
        VectorDrawableCompatState state = this.mVectorState;
    ...
    private void printGroupTree(VGroup currentGroup, int level) {
        ...
        sb4.append(currentGroup.getLocalMatrix().toString());
