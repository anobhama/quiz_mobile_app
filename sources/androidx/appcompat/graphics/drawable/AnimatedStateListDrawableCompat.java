...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
    ...
    static class AnimatedStateListState extends StateListState {
        ...
        public int getKeyframeIdAt(int index) {
            ...
            return ((Integer) this.mStateIds.get(index, Integer.valueOf(0))).intValue();
        }
    ...
    public static AnimatedStateListDrawableCompat create(Context context, int resId, Theme theme) {
        int type;
    ...
    public static AnimatedStateListDrawableCompat createFromXmlInner(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Theme theme) throws IOException, XmlPullParserException {
    ...
    public void inflate(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
    ...
    private int parseTransition(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        int next;
        int type;
        Theme theme2 = theme;
        TypedArray a = TypedArrayUtils.obtainAttributes(resources, theme2, attrs, R.styleable.AnimatedStateListDrawableTransition);
    ...
    private int parseItem(Context context, Resources resources, XmlPullParser parser, AttributeSet attrs, Theme theme) throws XmlPullParserException, IOException {
        int next;
        int type;
