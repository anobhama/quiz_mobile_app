...
class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        int j = maxActions2 - requiredItems2;
        ...
        int i3 = 0;
        while (i3 < itemsSize) {
            MenuItemImpl item2 = (MenuItemImpl) arrayList.get(i3);
            ...
            if (item2.requiresActionButton()) {
                ...
                if (item2.requestsActionButton() != 0) {
                    ...
                    boolean isAction2 = (j > 0 || inGroup) && widthLimit2 > 0 && (!actionMenuPresenter.mStrictWidthLimit || cellsRemaining > 0);
                    if (isAction2) {
                    ...
                    if (isAction2 && groupId2 != 0) {
                        ...
                        int j2 = 0;
                        while (j2 < i3) {
                            MenuItemImpl areYouMyGroupie = (MenuItemImpl) arrayList.get(j2);
