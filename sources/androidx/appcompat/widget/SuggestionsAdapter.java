  ...
  mth insns count: 21
    ...
    private Drawable getActivityIconWithCache(ComponentName component) {
        ...
        if (this.mOutsideDrawablesCache.containsKey(componentIconKey)) {
            ...
            if (cached != null) {
                r2 = cached.newDrawable(this.mProviderContext.getResources());
            }
            return r2;
        }
        Drawable drawable = getActivityIcon(component);
        if (drawable != null) {
            r2 = drawable.getConstantState();
        }
        this.mOutsideDrawablesCache.put(componentIconKey, r2);
        return drawable;
    }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder authority2 = new Builder().scheme("content").authority(authority);
        String str = BuildConfig.FLAVOR;
        Builder uriBuilder = authority2.query(str).fragment(str);
