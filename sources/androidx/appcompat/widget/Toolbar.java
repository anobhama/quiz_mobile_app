...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int right2 = width2 - paddingRight2;
        int[] collapsingMargins = this.mTempMargins;
        ...
        if (shouldLayout(this.mNavButtonView)) {
            if (isRtl) {
                right2 = layoutChildRight(this.mNavButtonView, right2, collapsingMargins, alignmentHeight2);
            } else {
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            if (isRtl) {
                right2 = layoutChildRight(this.mCollapseButtonView, right2, collapsingMargins, alignmentHeight2);
            } else {
        ...
        if (shouldLayout(this.mMenuView)) {
            if (isRtl) {
                ...
                right2 = layoutChildRight(this.mMenuView, right2, collapsingMargins, alignmentHeight2);
            }
        }
        ...
        collapsingMargins[1] = Math.max(0, contentInsetRight - ((width2 - paddingRight2) - right2));
        int left4 = Math.max(left3, contentInsetLeft);
        int right3 = Math.min(right2, (width2 - paddingRight2) - contentInsetRight);
        if (shouldLayout(this.mExpandedActionView)) {
            if (isRtl) {
                right3 = layoutChildRight(this.mExpandedActionView, right3, collapsingMargins, alignmentHeight2);
            } else {
        ...
        if (shouldLayout(this.mLogoView)) {
            if (isRtl) {
                right3 = layoutChildRight(this.mLogoView, right3, collapsingMargins, alignmentHeight2);
            } else {
        ...
        for (int i15 = 0; i15 < leftViewsCount; i15++) {
            left4 = layoutChildLeft((View) this.mTempViews.get(i15), left4, collapsingMargins, alignmentHeight);
        }
        int alignmentHeight3 = alignmentHeight;
        addCustomViewsWithGravity(this.mTempViews, 5);
        int rightViewsCount = this.mTempViews.size();
        for (int i16 = 0; i16 < rightViewsCount; i16++) {
            right = layoutChildRight((View) this.mTempViews.get(i16), right, collapsingMargins, alignmentHeight3);
        }
        ...
        int i17 = leftViewsCount;
        int i18 = 0;
        while (i18 < centerViewsCount) {
            int left7 = left4;
            centerLeft = layoutChildLeft((View) this.mTempViews.get(i18), centerLeft, collapsingMargins, alignmentHeight3);
            i18++;
            left4 = left7;
        }
