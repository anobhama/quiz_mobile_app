...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (ap != -1) {
            ...
            if (VERSION.SDK_INT >= 26 && a2.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        if (VERSION.SDK_INT >= 26 && a3.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
        ...
        if (a4.hasValue(R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a4.getInt(R.styleable.AppCompatTextView_drawableTintMode, -1), null));
        }
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        if (VERSION.SDK_INT >= 26 && a.hasValue(R.styleable.TextAppearance_fontVariationSettings)) {
            String fontVariation = a.getString(R.styleable.TextAppearance_fontVariationSettings);
            if (fontVariation != null) {
                this.mView.setFontVariationSettings(fontVariation);
            }
        }
