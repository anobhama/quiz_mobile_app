...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                while (i7 < count) {
                    ...
                    if (child2 == null) {
                        ...
                        if (isExactly) {
                            ...
                            this.mTotalLength = Math.max(maxHeight7, maxHeight7 + largestChildWidth9 + lp4.leftMargin + lp4.rightMargin + getNextLocationOffset(child2));
                        }
                    }
                    i = i2;
                    i7 = i + 1;
        ...
        if (skippedMeasure) {
            ...
            int i10 = widthSize2;
            largestChildWidth = alternativeMaxHeight8;
        } else if (delta4 == 0 || totalWeight2 <= 0.0f) {
            int alternativeMaxHeight9 = Math.max(alternativeMaxHeight8, weightedMaxHeight6);
            if (useLargestChild2 == 0) {
                float f = totalWeight2;
                ...
                while (i13 < count) {
                    ...
                    i13++;
                    alternativeMaxHeight9 = alternativeMaxHeight4;
                    totalWeight2 = totalWeight4;
        ...
        while (i24 < count) {
            int weightedMaxHeight7 = weightedMaxHeight6;
            View child4 = getVirtualChildAt(i24);
            if (child4 != null) {
                useLargestChild = useLargestChild2;
                count3 = count;
                if (child4.getVisibility() == 8) {
                    ...
                    if (isExactly) {
                        ...
                        int totalLength3 = this.mTotalLength;
                        this.mTotalLength = Math.max(totalLength3, child4.getMeasuredWidth() + totalLength3 + lp6.leftMargin + lp6.rightMargin + getNextLocationOffset(child4));
                    }
                    ...
                    int alternativeMaxHeight10 = Math.max(largestChildWidth, matchHeightLocally2 ? margin3 : childHeight3);
                    if (allFillParent2) {
            ...
            count = count3;
            weightedMaxHeight6 = weightedMaxHeight7;
            widthMode = widthMode3;
        }
        count2 = count;
        int i27 = widthMode;
        widthSizeAndState = widthSizeAndState3;
        int i28 = weightedMaxHeight6;
        int delta10 = delta5;
        ...
        if (maxAscent[1] == -1 && maxAscent[0] == -1 && maxAscent[2] == -1 && maxAscent[3] == -1) {
            ...
            maxHeight2 = Math.max(maxHeight9, Math.max(maxAscent[3], Math.max(maxAscent[0], Math.max(maxAscent[1], maxAscent[2]))) + Math.max(maxDescent[3], Math.max(maxDescent[0], Math.max(maxDescent[1], maxDescent[2]))));
        }
        int maxHeight10 = delta10;
