...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    private class ActionProviderWrapperJB extends ActionProviderWrapper implements VisibilityListener {
    ...
    public android.view.ActionProvider getActionProvider() {
        ActionProvider provider = this.mWrappedObject.getSupportActionProvider();
